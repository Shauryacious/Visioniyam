...
export default function Readocs(props) {
  ...
  return (
    <>
      <div className='Readheading' style={{textAlign: "center"}}>Documentation</div>
      <div style={{display: "flex", justifyContent: "center"}}>
        <div className='readbox' style={{paddingTop: "40px"}}>
          <div className='Readheading'>*System Requirements - Python &gt;=3.7 & &lt;=3.11</div>
          <div className='Readcontent'><li>1. Download and unzip the software with respect to your Operating System from the links given below.</li></div>
